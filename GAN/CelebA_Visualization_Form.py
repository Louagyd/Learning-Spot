...
class CelebA_Visualization_Form:
    def __init__(self, GAN, num_sliders = None, slider_width = 300):
        self.GAN = GAN
        self.z_init = np.random.normal(0, GAN.z_sd, GAN.z_len)
        if num_sliders is None:
            self.num_sliders = GAN.z_len
        else:
